...
const getLinkStyleClasses = (iconName: string, id: string, url: string, colorPreset?: string) => {

  // Color preset takes priority
  ...
  if (normalizedIcon === 'playcircle' || normalizedUrl.includes('play.google.com')) {
    return {
      container: 'bg-gradient-to-r from-[#07214a]/90 via-[#0a2f64]/80 to-[#020b18]/95 border-blue-500/30 hover:border-blue-400 shadow-[0_0_15px_-3px_rgba(37,99,235,0.22)]',
      iconBg: 'bg-gradient-to-br from-blue-500 to-blue-700 text-white border-blue-400/30',
      titleColor: 'text-blue-100 font-bold',
      subtitleColor: 'text-blue-300/60',
    };
  }
        ...
        <div className="space-y-4 px-1 flex-1">
          {links
            ...
            .map((link) => {
              ...
              const styling = getLinkStyleClasses(link.iconName, link.id, link.url, link.colorPreset);
